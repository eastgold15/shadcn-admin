...
describe("TasksMutateDrawer", () => {
  ...
  it("renders create title and description", async () => {
    const { getByRole, getByText } = await render(
      <TasksMutateDrawer onOpenChange={vi.fn()} open />
    );
  ...
  it("renders edit title, description, and prefilled title", async () => {
    const { getByRole, getByText } = await render(
      <TasksMutateDrawer currentRow={MOCK_TASK} onOpenChange={vi.fn()} open />
    );
  ...
  it("submits create form and shows submitted data", async () => {
    ...
    const { getByRole } = await render(
      <TasksMutateDrawer onOpenChange={onOpenChange} open />
    );
    ...
    function Harness() {
      ...
      return (
        <>
          ...
          <TasksMutateDrawer onOpenChange={setOpen} open={open} />
        </>
      );
    }
