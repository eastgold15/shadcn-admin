...
describe("UsersActionDialog", () => {
  ...
  describe("add user", () => {
    it("renders title and description", async () => {
      const { getByRole, getByText } = await render(
        <UsersActionDialog onOpenChange={vi.fn()} open />
      );
    ...
    it("shows the submitted data when the form is submitted successfully", async () => {
      ...
      const screen = await render(
        <UsersActionDialog onOpenChange={onOpenChange} open />
      );
  ...
  describe("edit user", () => {
    it("renders title and description", async () => {
      const { getByRole, getByText } = await render(
        <UsersActionDialog currentRow={MOCK_USER} onOpenChange={vi.fn()} open />
      );
